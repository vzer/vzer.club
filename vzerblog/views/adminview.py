...
from vzerblog.extensions import admin,db
from vzerblog.models.data_model import User,Category,Tag, Entry,Friend_link
reload(sys)
...
class EntryAdmin(ModelView):
    ...
    create_template = 'admins/create.html'
    edit_template = 'admins/edit.html'
